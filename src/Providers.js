...
import { URL_VOLUMES, URL_BOOKS } from "./utils/constants.js";
import GOOGLE_API_KEY from "./utils/keys.js";
...
const AppProviders = ({ children }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      Promise.all([getJSON(URL_VOLUMES), getJSON(URL_BOOKS)]).then(function (
        jsonResults
      ) {
